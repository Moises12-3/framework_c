...
//consulta para insertar
	    ...
	    //$insertar="INSERT INTO usuario (Fecha_Reg , code, name_user, Nombre, Apellido, 		Email , password,Telefono)  VALUES (now(),'$aleatorio', '$name_usuario', '$Primer_Nombre', '$Primer_Apellido', '$Email', '$password', '$Celular')";

		//`ID_USUARIO`, `Nombre`, `Apellido`, `Codigo`, `Celular`, `Email`, `Password`, `User`, `Fecha_Reg`
$insertar="INSERT INTO usuario ( `Nombre`, `Apellido`, `Codigo`, `Celular`, `Email`, `Password`, `User`, `Fecha_Reg`)  
VALUES ( '$Primer_Nombre', '$Primer_Apellido','$aleatorio',  '$Celular', '$Email', '$password','$name_usuario', now())";



$verificar_Email=mysqli_query($conex,"SELECT *  FROM usuario WHERE User='$name_usuario'  ");
